...
void ut_tileloading::initTestCase()
{
}

void ut_tileloading::cleanupTestCase()
{
}

void ut_tileloading::init()
{
    Quill::initTestingMode();
    Quill::setPreviewSize(0, QSize(4, 1));
}

void ut_tileloading::cleanup()
{
    Quill::cleanup();
}
...
void ut_tileloading::testSingleTile()
{
